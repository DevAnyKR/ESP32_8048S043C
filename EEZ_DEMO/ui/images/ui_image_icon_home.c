...
static const
LV_ATTRIBUTE_MEM_ALIGN LV_ATTRIBUTE_LARGE_CONST LV_ATTRIBUTE_IMG_ICON_HOME
uint8_t img_icon_home_map[] = {
...
const lv_image_dsc_t img_icon_home = {
  ...
  .header.h = 32,
  .header.stride = 64,
  .data_size = sizeof(img_icon_home_map),
  .data = img_icon_home_map,
};
